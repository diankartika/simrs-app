...
async function seedDatabase() {
  try {
    ...
    await MedicalCoding.deleteMany({});
    ...
    for (const caseStudy of caseStudies) {
      try {
        ...
        console.log(`✓ Created patient: ${patient.name} (${patient.patientNo})`);
        ...
        const medicalCoding = await MedicalCoding.create({
          ...caseStudy.coding,
          medicalRecordId: medicalRecord._id,
          codedBy: 'Admin',
          validationStatus: 'Validated',
          validatedBy: 'Quality Control'
        });
        console.log(`  ✓ Created medical coding`);
    ...
    console.log(`\n✅ Successfully seeded ${createdCount} case studies!`);
    console.log('\nDatabase is ready with sample data:');
    console.log('- 5 patients with different diagnoses');
    console.log('- 5 medical records with vital signs and treatment info');
    console.log('- 5 medical codings with ICD-10, ICD-9-CM, and SNOMED-CT codes');
